...
const TREE_DATA: FoodNode[] = [
  ...
  {
    name: 'Profesores',
    children: [{name: 'Listado', url: '', icon: 'assignment_ind'}, {name: 'Nuevo', url: '', icon: 'person_add'}, {name: 'Cargo Profesores', url: '', icon: 'class'}, {name: 'Categoria Profesores', url: '', icon: 'dns'}, {name: 'Especialidad Profesores', url: '/careers/list', icon: 'drag_handle'}]
  },
